...
with open(secrets_headers_target_path, "w") as f:
    ...
    f.write("\n")
    f.write("/* MQTT Config*/\n")
    f.write(f"#define AWS_IOT_PUBLISH_TOPIC   \"{secrets_outputs['device_name']['value']}/pub\"\n")
    f.write(f"#define AWS_IOT_SUBSCRIBE_TOPIC   \"{secrets_outputs['device_name']['value']}/sub\"\n")
    f.write("\n")
    f.write("// WiFi CREDS\n")
    f.write("// -----------------------------\n")
    f.write("\n")
